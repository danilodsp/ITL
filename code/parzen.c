...
mcc -T link:mex -W none parzen.c

% 
% Estima a probabilidade p(x) dado o conjunto de dados utilizando o
% conceito de janelas de Parzen
%
% D -> Conjunto de dados
% x -> ponto onde se quer saber a probabilidade
% Vo -> Volume da janela de Parzen
%
